...
This mechanism has been integrated into Bitcore-Node-Electra which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/electralliumcoin/insight-api-electra#web-socket-api](https://github.com/electralliumcoin/insight-api-electra#web-socket-api) 
* API: [https://github.com/electralliumcoin/insight-api-electra#swifttx-transactions](https://github.com/electralliumcoin/insight-api-electra#swifttx-transactions) 
...
By default, the Electra daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Electra daemon:
