...
In order to support loading of multiple wallets in electra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is electra.cpp.
...
Changes to electra.cpp
----------------------
electra.cpp is the entry point into electra-qt, and as such, will require some minor modifications to provide hooks for
