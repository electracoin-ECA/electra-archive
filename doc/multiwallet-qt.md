...
In order to support loading of multiple wallets in myce-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is myce.cpp.
...
Changes to myce.cpp
----------------------
myce.cpp is the entry point into myce-qt, and as such, will require some minor modifications to provide hooks for
