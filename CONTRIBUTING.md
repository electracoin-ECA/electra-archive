Contributing to Myce
============================

The Myce project operates an open contributor model where anyone is
...
The following applies to code changes to the Myce project, and is not to be
confused with overall Myce Network Protocol consensus changes.

Whether a pull request is merged into Myce rests with the project merge
...
Patches that change Myce consensus rules are considerably more involved than
...
Where a patch set proposes to change the Myce consensus, it must have been
...
The project leader is the release manager for each Myce release.
