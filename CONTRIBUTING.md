Contributing to Electra Core
============================

The Electra Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Electra Core project, and is not to be
confused with overall Electra Network Protocol consensus changes.

Whether a pull request is merged into Electra Core rests with the project merge
...
Patches that change Electra consensus rules are considerably more involved than
...
Where a patch set proposes to change the Electra consensus, it must have been
...
The project leader is the release manager for each Electra Core release.
