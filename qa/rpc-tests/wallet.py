...
#   c) node1 mines 32 blocks, so now node 0 has 60001yce, node 1 has 4250yce, node2 has none.
#   d) node0 sends 601 yce to node2, in two transactions (301 yce, then 300 yce).
