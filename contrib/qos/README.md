...
This means one can have an always-on electrad instance running, and another local electrad/electra-qt instance which connects to this node and receives blocks from it.
