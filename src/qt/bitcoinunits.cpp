...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ECA:
        return QString("electra");
    case mECA:
        return QString("melectra");
    case uECA:
        return QString::fromUtf8("uelectra");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ECA:
            return QString("ECA");
        case mECA:
            return QString("Milli-ECA (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-ECA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
