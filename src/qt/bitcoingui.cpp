                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ELECTRA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Electra address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and electra: URIs)"));
...
//    }
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Electra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Electra Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Electra"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Electra addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Electra addresses"));
    ...
    openAction->setStatusTip(tr("Open a Electra: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Electra Core help message to get a list with possible Electra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Electra Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Electra Core"); // default title
...
{   
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        labelStakingIcon->setToolTip(tr("Staking is active\n Your weight is %1<br>Network weight is %2<br>Expected time to earn reward is %3\n MultiSend: %4").arg(nWeight).arg(nNetworkWeight).arg(text).arg(fMultiSend ? tr("Active") : tr("Not Active")));
    } else {
        labelStakingIcon->show();
