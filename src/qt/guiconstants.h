...
/* Electra GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ELECTRA"
#define QAPP_ORG_DOMAIN "electraproject.org"
#define QAPP_APP_NAME_DEFAULT "ELECTRA-Qt"
#define QAPP_APP_NAME_TESTNET "ELECTRA-Qt-testnet"
